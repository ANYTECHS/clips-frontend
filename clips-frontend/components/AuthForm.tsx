  ...
  return (
    <div id="auth-card" className="w-[440px] bg-surface/80 backdrop-blur-md rounded-[20px] p-[38px] shadow-[0_4px_40px_rgba(0,0,0,0.5)] border border-border relative overflow-hidden">
      ...
      <form onSubmit={handleAuthSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-[13px] font-medium text-muted mb-2">Email address</label>
          <input 
            type="email" 
            required
            value={email}
        ...
        <div>
          <label className="block text-[13px] font-medium text-muted mb-2">Password</label>
          <input 
            type="password" 
            required
            value={password}
