      ...
      <div className="flex items-center gap-3 flex-1 max-w-md">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full bg-surface border border-border rounded-xl pl-10 pr-4 py-2.5 text-[14px] text-white placeholder:text-subtle focus:outline-none focus:border-brand/30 focus:bg-surface transition-colors"
          />
        </div>
      </div>
