          ...
          <div className="flex-1 space-y-8 max-w-[580px]">
            ...
            <div className="flex items-center gap-4 text-sm text-muted pt-2">
              <div className="flex -space-x-2.5">
                <div className="w-9 h-9 rounded-full border-2 border-background bg-zinc-800 flex items-center justify-center text-[10px] overflow-hidden"><img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="user" className="w-full h-full object-cover"/></div>
                <div className="w-9 h-9 rounded-full border-2 border-background bg-zinc-700 flex items-center justify-center text-[10px] overflow-hidden"><img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Aneka" alt="user" className="w-full h-full object-cover"/></div>
                <div className="w-9 h-9 rounded-full border-2 border-background bg-zinc-600 flex items-center justify-center text-[10px] overflow-hidden"><img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Jocelyn" alt="user" className="w-full h-full object-cover"/></div>
              </div>
