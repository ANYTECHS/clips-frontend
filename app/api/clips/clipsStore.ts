...
class ClipsStore {
  ...
  private seed() {
    ...
    const mockClips = [
      {
        id: "1",
        title: "Clip #01 - The Big Reveal Hook",
        ...
        scoreBreakdown: { hook: 96, retention: 92, emotional: 90, trending: 98 },
        tags: ["tutorial", "hook"],
      },
      {
        id: "2",
        title: "Clip #02 - Technical Deep Dive",
        ...
        scoreBreakdown: { hook: 70, retention: 65, emotional: 60, trending: 75 },
        tags: ["technical", "education"],
      },
      {
        id: "3",
        title: "Clip #03 - Audience Reaction",
        ...
        scoreBreakdown: { hook: 85, retention: 80, emotional: 88, trending: 75 },
        tags: ["reactions", "engagement"],
      },
      {
        id: "4",
        title: "Clip #04 - Feature Walkthrough",
        thumbnail: "/projects/thumb1.png",
        score: 91,
        scoreKey: "high",
        duration: "00:52",
        ...
        scoreBreakdown: { hook: 92, retention: 90, emotional: 85, trending: 95 },
        tags: ["tutorial", "product"],
      },
      {
        id: "5",
        title: "Clip #05 - Closing Remarks",
        thumbnail: "/projects/thumb2.png",
        score: 42,
        scoreKey: "low",
        duration: "01:12",
        ...
        scoreBreakdown: { hook: 45, retention: 40, emotional: 38, trending: 45 },
        tags: ["outro"],
      },
      {
        id: "6",
        title: "Clip #06 - Product Detail B-Roll",
        thumbnail: "/projects/thumb3.png",
        score: 89,
        scoreKey: "high",
        duration: "00:44",
        ...
        scoreBreakdown: { hook: 90, retention: 88, emotional: 85, trending: 92 },
        tags: ["product", "broll", "campaign-q4"],
      },
    ];
  ...
  getClipsForUser(
    userId: string,
    options: { includeArchived?: boolean; keepDuplicates?: boolean } = {}
  ): Clip[] {
  ...
  private dedupeClips(clips: Clip[], userId: string): Clip[] {
    ...
    for (const clip of clips) {
      ...
      if (seen.has(fingerprint)) {
        logger.info("[clips] duplicate clip hidden", {
          userId,
          clipId: clip.id,
          fingerprint,
        });
  ...
  getArchivedClipsForUser(userId: string): Clip[] {
    return this.clips.filter((c) => c.userId === userId && !c.deletedAt && Boolean(c.archivedAt));
  }
  ...
  findUnownedClipIds(userId: string, clipIds: string[]): string[] {
    const owned = new Set(this.clips.filter((c) => c.userId === userId).map((c) => c.id));
  ...
  getClipById(userId: string, clipId: string): Clip | undefined {
    return this.clips.find((c) => c.userId === userId && c.id === clipId && !c.deletedAt);
  }
