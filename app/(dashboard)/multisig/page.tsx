...
import { AlertCircle,CheckCircle2, ExternalLink, Loader2, Shield } from "lucide-react";
...
import { getStellarLabUrl, type StellarNetwork } from "@/app/lib/networkConfig";
...
export default function MultisigPage() {
  ...
  const networkLabel = useMemo(() => (network === "mainnet" ? "Mainnet" : "Testnet"), [network]);
  ...
  const { executeTransaction, status, isLoading, error, result, transactionHash, reset } =
  ...
  const explorerUrl = transactionHash ? getStellarLabUrl(transactionHash, network) : "";
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1 max-w-2xl">
            Configure multisignature on your Stellar wallet by adding an extra signer and setting
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Use a second signer and higher thresholds to require multiple approvals before a
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-surface border border-white/5 rounded-2xl p-6 space-y-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
            ...
            <p>
              The first signer is your current account. The second signer is an added public key
              that must also approve transactions once thresholds are raised.
            </p>
            <p className="mt-2">
              A common multisig setup is <strong>master weight 1 / med 2 / high 2</strong>. This
              means both signers are required for payments and account management.
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Your multisig settings were submitted. You can review the transaction on Stellar
                Lab.
              </p>
              <a
                href={explorerUrl}
